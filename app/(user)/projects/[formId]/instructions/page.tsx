...
export default function WidgetImplementation({
  params,
}: {
  ...
  return (
    <div className="container mx-auto px-4 text-white">
      <h1 className="md:text-4xl font-bold mb-3 ">
        Implement the <span className="text-blue-500">Widget</span>
      </h1>
      <p className="text-lg mb-8 text-slate-200">
        Choose a widget style and add it to your website
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {widgets.map((widget) => (
          <Card
            key={widget.id}
            className={`bg-[#202020] cursor-pointer transition-all duration-200 border-[#303030] ${selectedWidget.id === widget.id ? "ring-4 ring-[#353535]" : ""}`}
      ...
      <Card className="mb-8 bg-[#202020] border-[#303030]">
        ...
        <CardContent className="bg-[#202020]">
          ...
          <div className="flex items-center mt-4">
            <Button
              onClick={copyCode}
              className="bg-[#303030] hover:bg-[#353535]"
            >
