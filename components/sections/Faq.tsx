...
const faqData: FaqDataProps[] = [
    {
        ...
        description: "QuickFeed comes with full multilingual support. Our platform is designed to seamlessly handle multiple languages, ensuring a smooth and accessible experience for everybody in your organisation."
    },
    {
