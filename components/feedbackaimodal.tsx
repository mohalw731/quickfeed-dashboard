...
export default function FeedbackAnalysisModal({ feedbackMessages, trigger }: FeedbackAnalysisModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[700px]  max-w-[350px] rounded-xl">
        <DialogHeader>
          {/* <DialogTitle>Feedback Analysis</DialogTitle> */}
        </DialogHeader>
        <Card className="w-full space-y-6  bg-white rounded-lg border-none">
          ...
          {analysis && (
            <div className="mt-6 p-4 bg-gray-100 rounded-xl transition-all duration-300 ease-in-out max-h-[300px] overflow-y-auto">
              <h3 className="text-lg font-semibold mb-2 text-gray-800">Latest Analysis Result</h3>
