      ...
      <ul className="flex flex-col md:gap-32 gap-24">
        ...
        <li className="flex md:gap-12 md:flex-row-reverse flex-col gap-6 ">
          <div className="flex flex-col gap-4 max-w-lg h-full ">
            ...
            <p className="text-slate-500 tracking-wide leading-6 md:text-base text-sm">
              Empower your customers to share their opinions directly on your
              website with our easy-to-use widget. Collect real-time feedback,
              suggestions, and reviews that help you understand customer needs
              and improve your products and services. Build trust, engage your
              audience, and elevate your business through meaningful feedback.
            </p>
            <div className="flex items-end justify-between">
              <Link href={"/sign-up"}>
                <Button className="mt-4 bg-blue-500 hover:bg-blue-600 hover:scale-105 ">
        ...
        <li className="flex md:gap-12 md:flex-row flex-col gap-6 ">
          <div className="flex flex-col gap-4 max-w-lg h-full ">
            ...
            <p className="text-slate-500 tracking-wide leading-6 md:text-base text-sm">
              Move beyond collecting feedback—understand it with our AI-driven
              analysis. QuickFeed automatically summarizes feedback, identifies
              key themes, and offers actionable solutions to address any issues.
              Use these insights to enhance your customer experience and
